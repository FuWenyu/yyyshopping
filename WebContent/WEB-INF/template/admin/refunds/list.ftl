...
<title>${message("admin.refunds.list")} - EASY SHOPPING</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.refunds.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;"[#if page.searchProperty == "payee"] class="current"[/#if] val="payee">${message("Refunds.payee")}</a>
						</li>
					</ul>
				</div>
			</div>
