	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="vendor_code">售货机编码</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="vendor_name">售货机名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="sn">商品编码</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="product_name">商品名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="number">余量</a>
				</th>
				<th>
					<span>${message("admin.common.handle")}</span>
				</th>
			</tr>
			[#list page.content as inventory]
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${inventory.id}" />
					</td>
					<td>
					...
					<td>
						<a href="edit.jhtml?id=${inventory.id}">[编辑]</a>
					</td>
				</tr>
			[/#list]
		</table>
