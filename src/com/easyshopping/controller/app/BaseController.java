...
public class BaseController {
	...
	/** 错误消息 */
	protected static final Message ERROR_MESSAGE = Message.error("app.message.error");

	/** 成功消息 */
	protected static final Message SUCCESS_MESSAGE = Message.success("app.message.success");
